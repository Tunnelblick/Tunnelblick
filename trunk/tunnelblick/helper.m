...
void updateEasyRsa(BOOL silently) {
    ...
    if (  installType == update  ) {
        easyRsaInstallFailed(NSLocalizedString(@"easy-rsa updates are not supported by this version of Tunnelblick", @"Window text"));
        return;
    }
...
BOOL tunnelblickTestAppInApplications(void)
{
    ...
    return [appPath isEqualToString: @"/Applications/Tunnelblick.app"];
}
