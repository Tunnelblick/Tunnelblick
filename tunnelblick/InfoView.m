...
-(void) awakeFromNib
{
    ...
    NSArray * locCredits = [NSArray arrayWithObjects:
							[NSArray arrayWithObjects: @"Sobhi Abufool",                 NSLocalizedString(@"Arabic localization",                  @"Credit description"), nil],
                            ...
                            [NSArray arrayWithObjects: @"Catalin Comanici",              NSLocalizedString(@"Romanian localization",                @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Mohamad Deek",                  NSLocalizedString(@"Arabic localization",                  @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Marco Firsching",               NSLocalizedString(@"German localization",                  @"Credit description"), nil],
                            ...
                            [NSArray arrayWithObjects: @"Igor Gojkovic",                 NSLocalizedString(@"Croatian localization",                @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Christophe Icard",              NSLocalizedString(@"French localization",                  @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Tuomo Karhu",                   NSLocalizedString(@"Finnish localization",                 @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Klaus Marx",                    NSLocalizedString(@"German localization",                  @"Credit description"), nil],
							...
							[NSArray arrayWithObjects: @"Alexander Strashilov",          NSLocalizedString(@"Bulgarian localization",               @"Credit description"), nil],
