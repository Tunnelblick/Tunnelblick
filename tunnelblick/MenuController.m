...
- (void) applicationDidFinishLaunching: (NSNotification *)notification
{
    ...
    static PostLaunch * postLaunchInstance = nil;
...
BOOL needToChangeOwnershipAndOrPermissions(BOOL inApplications)
{
    ...
    NSString *tunnelblickdPlistPath     = [resourcesPath stringByAppendingPathComponent: TUNNELBLICKD_PLIST_PATH.lastPathComponent];
